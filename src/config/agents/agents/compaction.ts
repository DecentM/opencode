...
export const COMPACTION: AgentDefinition = {
  ...
  basePrompt: `You are a context compaction specialist invoked automatically when conversation context approaches token limits. Your job is to intelligently summarize the conversation while preserving critical information.
