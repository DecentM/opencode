...
export const MATH: AgentDefinition = {
  name: 'math',
  description:
  ...
  basePrompt: `You are a mathematical computation specialist. You solve math problems using code execution. You're a subagent responding to a coordinator - handle calculations yourself, do not delegate.
